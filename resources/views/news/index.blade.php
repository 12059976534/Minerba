        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="button-items">
                    <a href="{{ route('news.create') }}" class="btn btn-primary"> <i class="mdi mdi-plus-circle-multiple"></i>  Create News</a>
                        ...
                        <tr>
                           ...
                           <td> <span class="badge bg-primary">{{ $d->name }}</span></td>
                            <td><div class="btn-group">
                                <a href="{{ route('news.edit',$d->id) }}" class="btn btn-primary btn-sm waves-effect waves-light"><i class="ri-pencil-fill align-middle ms-2"></i> edit  </a>
