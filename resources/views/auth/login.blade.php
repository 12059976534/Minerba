                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="">
                                    ...
                                    <p class="mb-5 text-center">Sign in to continue to E-Minerba.</p>
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-primary-50">Don't have an account ? <a href="{{ route('register') }}" class="fw-medium text-primary"> Register </a> </p>
