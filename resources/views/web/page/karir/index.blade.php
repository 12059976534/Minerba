        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="product">
                                ...
                                <div class="product-descr">
                                    ...
                                    <a href="">
                                    <i class="fa fa-map-marker" aria-hidden="true"> Jakarta Selatan</i>
                                    </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4 col-md-pull-8 col-xs-12 shop-sidebar">
                    ...
                    <!-- Start of Cart -->
                    <div class="col-md-12 mt40 cart-sidebar">
                    ...
                    <div class="col-md-12 price-filter mt40">
                        <h4 class="widget-title">Price Filter</h4>

                        <div id="price-slider"></div>

                        <div class="price-slider-amount mt40">
                            <input type="text" id="amount" name="price" placeholder="Add Your Price">
                            <button class="btn btn-blue btn-effect" type="submit">Filter</button>
                        </div>
                    ...
                    <div class="col-md-12 clearfix mt40">
                        ...
                        <div class="sidebar-product">
                            ...
                            <div class="product-info">
                                <a href="shop-product.html">Cariera T-Shirt</a>
                                <span>29.99$</span>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-product">
                            ...
                            <!-- Link -->
                            <div class="product-info">
                                <a href="shop-product.html">Cariera Cap</a>
                                <span>19.99$</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 mt40">
                        <h4 class="widget-title">our advert</h4>
