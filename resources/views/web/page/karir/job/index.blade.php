  ...
  <section class="search-jobs ptb80" id="version4">
    <div class="container">
        ...
        <div class="row mt10">
            ...
            <div class="col-md-12">
                <a href="" class="btn btn-blue btn-small btn-effect"><i class="fa fas-plus"></i>+ Pasang Lowongan</a>
            </div>
            ...
            <div class="col-md-12 mt20">
                <div class="item-block shadow-hover">
                    ...
                    <div class="job-post-header clearfix">
                        <a href="company-page-1.html"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8_-Z0H7E3zOzcZ_ZILo3CIRT5CCcTfdHTrmtyjFlP62Z0O21EWVP30ULDIFwiVXQYxvg&usqp=CAU" alt=""></a>
                        <div>
                            <a href="job-page.html"><h4>PT PICOTEL NUSANTARA</h4></a>
                    ...
                    <div class="job-post-footer row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <span>RP 40.000 - RP 600.000 / hour</span>
                        </div>
            ...
            <div class="col-md-12 mt30">
                <div class="item-block shadow-hover">
                    ...
                    <div class="job-post-header clearfix">
                        <a href="company-page-1.html"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8_-Z0H7E3zOzcZ_ZILo3CIRT5CCcTfdHTrmtyjFlP62Z0O21EWVP30ULDIFwiVXQYxvg&usqp=CAU" alt=""></a>
                        <div>
                            <a href="job-page.html"><h4>PT IMENERBA</h4></a>
